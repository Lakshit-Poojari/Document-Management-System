...
export async function createDocumentService(document: CreateDocument) {
    try {
        if (!document.title || !document.file_name || !document.file_path || !document.uploaded_by || !document.category_id) {
