...
export default function Home() {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center dark:bg-gray-800 px-8 bg-amber-50">
        <div className="max-w-4xl text-center ">
          <h1 className="text-5xl dark:text-amber-400 font-bold text-amber-900 mb-6">
        ...
        <div className="bg-white shadow-2xl rounded-2xl p-8 dark:bg-gray-700">
          <h2 className="text-3xl font-semibold text-amber-800 dark:text-amber-400  mb-6">Features</h2>
          <br />
